            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        ...
                        <p><a href="/shop" class="btn btn-secondary me-2">Shop Now</a><a href="/about"
		...
		<div class="untree_co-section">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-12 col-md-6 col-lg-4 mb-5 mb-md-0">
						...
						<h3 clas><a href="#"><span class="">Samuel</span> D'Goat</a></h3>
            ...
            Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
					...
					<div class="col-12 col-md-6 col-lg-4 mb-5 mb-md-0">
						...
						<h3 clas><a href="#"><span class="">Bastien</span> Roupert</a></h3>
            <span class="d-block position mb-4">CEO, Founder, Atty.</span>
            <p>Separated they live in.
            Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
					...
					<div class="col-12 col-md-6 col-lg-4 mb-5 mb-md-0">
						...
						<h3 clas><a href="#"><span class="">Paul</span> Claverie</a></h3>
            <span class="d-block position mb-4">CEO, Founder, Atty.</span>
            <p>Separated they live in.
            Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
					</div> 
